    ...
    <div class="container padding-format pb-4">
      <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-4 d-flex justify-content-center align-items-center my-4">
          ...
          <p class="title-text text-center">Our Courses</p>
        </div>
      </div>
      <div class="row">
        <!-- Card 1 -->
        ...
        <div class="col-lg-12 text-center">
          <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-12 d-flex justify-content-center align-items-center my-4">
              ...
              <p class="title-text text-center">Career Opportunities</p>
            </div>
          </div>
        ...
        <div class="col-lg-12">
          <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-12 d-flex justify-content-center align-items-center my-4">
              ...
              <p class="title-text text-center">Our Activities</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="col-md-12">
                <div class="row d-flex align-items-center">
                  <div class="col-md-12 d-flex align-items-center my-4">
                    ...
                    <p class="title-text text-center">Our Students Diversity</p>
                  </div>
                </div>
        ...
        <div class="col-lg-12">
          <div class="row d-flex align-items-center">
            <div class="col-md-12 d-flex justify-content-center align-items-center my-4">
              ...
              <p class="title-text text-center">Our Students' Testimonials</p>
            </div>
          </div>
        </div>
      </div>
